...
namespace LARP.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [DataType(DataType.Password)]
            [Display(Name = "确认密码")]
            [Compare("Password", ErrorMessage = "两个密码不匹配.")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new ScriptUser { UserName = Input.Email, Email = Input.Email };
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "验证你的邮件",
                        $"点击后方的链接来确认你的邮件 <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>点我验证邮件</a>.");
